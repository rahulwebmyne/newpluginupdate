...
Open-source freedoms mean full ownership of content and data forever â€“ plus the expertise of a friendly [global community](https://woocommerce.com/meetups/?utm_source=wp%20org%20repo%20listing&utm_content=3.6).
...
Start a monthly wine subscription box, offer a discount on yoga mats to members whoâ€™ve attended 10+ classes, offer configurable hampers or personalized jewelry â€“ itâ€™s all possible with WooCommerce.
...
WooCommerce gives you complete control â€“ from taxes to stock levels to customer accounts. Add and remove extensions, change your storeâ€™s design, and switch themes or hosts or payment service providers, all as you please. 
...
With WooCommerce, your data belongs to you. One of the risks of using a hosted eCommerce platform the risk of losing your store if the provider closes. WooCommerce store data is future-proof -- youâ€™re are free to export all your content and take your site  wherever you choose.
...
WooCommerce allows developers to easily create, modify, and scale a store that meets clientâ€™s specifications, and to make enhancements either with extensions or with customs solution.

No matter the size of the store you want to build, WooCommerce has a robust framework that supports stores from basic to enterprise â€“ with content and commerce in a single, central location.

WooCommerce is audited by a dedicated team of developers who work across time zones to identify and patch any and all discovered bugs. There is comprehensive, easily-accessible documentation that is updated with each release. With our docs, youâ€™ll learn how to create the site your client needs.

= Join our growing community =

WooCommerce is one of the fastest-growing eCommerce communities. Weâ€™re proud that the helpfulness of the community and wealth of resources available online are frequently cited as reasons our users love it.

There are 80+ [WooCommerce Meetups](https://woocommerce.com/woocommerce/meetups/?utm_source=wp%20org%20repo%20listing&utm_content=3.6) taking place in cities across the world that you can attend for free and even get involved in running. WooCommerce also has a regular presence at WordCamps across the globe â€“ and weâ€™d love to meet you.

If youâ€™re interested in contributing to WooCommerce weâ€™ve got more than 350 contributors, and thereâ€™s always room for more. Head to the [WooCommerce GitHub Repository](https://github.com/woocommerce/woocommerce?utm_source=wp%20org%20repo%20listing&utm_content=3.6) to find out how you can pitch in.

WooCommerce is currently 100% translated into 24 languages, including Danish, Ukrainian, and Persian. If youâ€™re interested in helping to localize WooCommerce by adding your local language, visit [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/woocommerce?utm_source=wp%20org%20repo%20listing&utm_content=3.6).
...
Automatic installation is the easiest option -- WordPress will handles the file transfer, and you wonâ€™t need to leave your web browser. To do an automatic install of WooCommerce, log in to your WordPress dashboard, navigate to the Plugins menu, and click â€œAdd New.â€
 
In the search field type â€œWooCommerce,â€ then click â€œSearch Plugins.â€ Once youâ€™ve found us,  you can view details about it such as the point release, rating, and description. Most importantly of course, you can install it by! Click â€œInstall Now,â€ and WordPress will take it from there.
...
If you encounter issues with the shop/category pages after an update, flush the permalinks by going to WordPress > Settings > Permalinks and hitting â€œSave.â€ That should return things to normal.
...
â€œWooCommerceâ€ has been translated into 55 locales. Thank you to [the translators](https://translate.wordpress.org/projects/wp-plugins/woocommerce/contributors) for their contributions. [Translate â€œWooCommerceâ€ into your language](https://translate.wordpress.org/projects/wp-plugins/woocommerce?utm_source=wp%20org%20repo%20listing&utm_content=3.6).
...
* Fix - null issue in wpNavMenuClassChange #4513 ðŸŽ‰ gradosevic 
